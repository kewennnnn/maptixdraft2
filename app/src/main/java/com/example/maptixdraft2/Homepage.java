...
public class Homepage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<ListItem> userHelperList = new ArrayList<>();
        userHelperList.add(new ListItem("Chocolate","100"));
        userHelperList.add(new ListItem("Chonky cat","100"));
        userHelperList.add(new ListItem("Bread","100"));
